...
<Info>
  **Parallel Function Calling**: Emby supports parallel function execution for improved performance.
</Info>
...
Emby supports calling multiple functions in parallel for better performance:
