...
<CardGroup cols={1}>
  ...
  <Tip title="Predictable Pricing" icon="credit-card" style={{ backgroundColor:"#bb1515ff !important"}}>
...
<CardGroup cols={2}>
  ...
  <Card title="Anthropic API" icon="microchip-ai" href="/core-features/anthropic">
    Full support for Claude models with Anthropic API format
  </Card>
  <Card title="Models Catalog" icon="hexagon-nodes" href="/core-features/models">
