---
title: Roo Code Configuration
sidebarTitle: "Roo Code"
icon: code-branch
---

RooCode is a powerful standalone AI coding assistant application with an interactive chat interface, code review capabilities, and multi-file editing. Configure it to use Emby for access to multiple AI models.
...
<Tabs>
  ...
  <Tab title="Import Configuration">
    ...
    **Step 1**: Create `roocode-Emby-config.json`
    ...
    **Step 2**: Import in RooCode
    ...
    3. Select your `roocode-Emby-config.json`
...
<Steps>
  ...
  <Step title="Get Emby API Key">
    1. Visit [Emby Dashboard](https://emby.ai/dashboard)
    2. Sign up or log in
    3. Navigate to **API Keys** section
    4. Click **Create New Key**
    5. Copy the key (starts with `sk-emby-`)
  </Step>
  ...
  <Step title="Configure API Provider">
    ...
    4. Enter **Base URL**: `https://dev.emby.ai/v1`
    5. Paste **API Key**: `sk-emby-your-key`
...
- Emby API key ([Get yours](https://emby.ai/dashboard))

## Setup Steps

### 1. Get Your Personal API Key
1. Go to https://emby.ai/dashboard
2. Navigate to **API Keys**
3. Click **Create New Key**
4. Copy your key (starts with `sk-emby-`)
...
## Support
Contact team lead or check [Emby Docs](https://docs.emby.ai)
```
...
Switching from another AI coding tool to RooCode with Emby:

**Current Setup: Using Cursor with OpenAI**

**Why Switch to RooCode + Emby:**
...
<Steps>
  ...
  <Step title="Configure Emby">
    ```json  theme={null}
    {
      "provider": "openai-compatible",
      "api": {
        "baseURL": "https://dev.emby.ai/v1",
        "apiKey": "sk-emby-your-Emby-key",
        "model": "gpt-5"
      }
    }
    ```
  ...
  <Accordion title="Connection timeout errors">
    ...
    **Solutions:**
    ...
    1. **Verify base URL is correct:**
       ```
       https://dev.emby.ai/v1  <Icon icon="check" /> Correct
       https://dev.emby.ai     <Icon icon="xmark" /> Missing /v1
    ...
    2. **Test connectivity:**
       ```bash  theme={null}
       # Test connection
       curl -I https://dev.emby.ai/v1/models
  ...
  <Accordion title="API key not recognized">
    ...
    **Solutions:**
    ...
    2. **Check key is active:**
       * Login to [Dashboard](https://emby.ai/dashboard)
       * Go to **API Keys**
    ...
    4. **Test key directly:**
       ```bash  theme={null}
       curl -H "Authorization: Bearer sk-emby-your-actual-key" \
...
<CardGroup cols={2}>
  ...
  <Card title="Monitor Usage" icon="chart-line">
    Check [Dashboard](https://emby.ai/dashboard) regularly for token usage
  </Card>
...
```bash  theme={null}
export EMBY_API_KEY="sk-emby-your-key"
export EMBY_BASE_URL="https://dev.emby.ai/v1"
```
...
<CardGroup cols={3}>
  <Card title="Kilo Code Setup" icon="code" href="/integrations/kilo-code">
    Configure Kilo Code VSCode extension
  </Card>

  <Card title="Cline Setup" icon="terminal" href="/integrations/cline">
