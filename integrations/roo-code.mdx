...
<Steps>
  ...
  <Step title="Get Emby API Key">
    1. Visit [Emby Dashboard](https://dev.emby.ai/home)
    2. Sign up or log in
...
- Emby API key ([Get yours](https://dev.emby.ai/home))

## Setup Steps

### 1. Get Your Personal API Key
1. Go to https://dev.emby.ai/home
  ...
  <Accordion title="Connection timeout errors">
    ...
    **Solutions:**
    ...
    1. **Verify base URL is correct:**
       ```
       https://dev.emby.ai/v1  \u2713 Correct
       https://dev.emby.ai     \u2717 Missing /v1
  ...
  <Accordion title="API key not recognized">
    ...
    **Solutions:**
    ...
    2. **Check key is active:**
       * Login to [Dashboard](https://dev.emby.ai/home)
       * Go to **API Keys**
...
<CardGroup cols={2}>
  ...
  <Card title="Monitor Usage" icon="chart-line">
    Check [Dashboard](https://dev.emby.ai/home) regularly for token usage
  </Card>
