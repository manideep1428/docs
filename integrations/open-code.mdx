...
## Prerequisites
1. Get Emby API key from https://dev.emby.ai/dashboard
    ...
    **Common mistakes:**
    ...
    ```json  theme={null}
    {
      "provider": {
        "anthropic": {
          "options": {
            "baseURL": "https://dev.emby.ai/v1"  // <Icon icon="check" /> Correct
            // "baseURL": "https://dev.emby.ai/v1/"  // <Icon icon="xmark" /> Wrong (trailing slash)
            // "baseURL": "https://dev.emby.ai"  // <Icon icon="xmark" /> Wrong (missing /v1)
          }
        }
      }
    }
