---
title: 'Cropping and Adjusting Before Upload'
description: 'How to frame your composition perfectly'
icon: 'crop'
---

You can crop, rotate, and adjust brightness/contrast right in the app after upload to frame your composition perfectly.
